<template>
  <div class="text-left desktop:px-52">
    <h2 class="h2-medium py-6">Privacy Policy</h2>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
      Your privacy is important to us. It is Ádám Sárpátki&#39;s policy to
    ...
    <h3 class="pb-6 pt-4 h3-medium">Information We Collect</h3>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h4 class="pb-6 pt-4 h4-medium">Log Data</h4>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h4 class="pb-6 pt-4 h4-medium">Personal Information</h4>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h4 class="pb-6 pt-4 h4-medium">Collection and Use of Information</h4>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h4 class="pb-6 pt-4 h4-medium">Security of Your Personal Information</h4>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 h3-medium">Children’s Privacy</h3>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 h3-medium">Limits of Our Policy</h3>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 h3-medium">Changes to This Policy</h3>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 h3-medium">Contact Us</h3>
    <p class="pl-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h2 class="h2-medium py-6">Copyright Info</h2>
    <p class="pl-6 pb-12 desktop:paragraph-regular paragraph-mobile-small">Icons made by <a href="https://www.freepik.com" title="Freepik">Freepik</a>, by <a href="https://www.flaticon.com/authors/xnimrodx" title="xnimrodx">xnimrodx</a> and by <a href="https://www.flaticon.com/authors/photo3idea-studio" title="photo3idea_studio">photo3idea_studio</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></p>
