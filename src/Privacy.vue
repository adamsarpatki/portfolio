<template>
  <div class="text-left desktop:px-32 md:px-6">
    <h2 class="h2-medium py-6 px-4">Privacy Policy</h2>
    ...
    <h4 class="px-4 pb-6 pt-4 h4-medium">Log Data</h4>
    <p class="sm:pl-6 px-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h4 class="pb-6 pt-4 px-4 h4-medium">Security of Your Personal Information</h4>
    <p class="sm:pl-6 px-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 px-4 h3-medium">Children’s Privacy</h3>
    <p class="sm:pl-6 px-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 px-4 h3-medium">
    ...
    <h3 class="pb-6 pt-4 px-4 h3-medium">Limits of Our Policy</h3>
    <p class="sm:pl-6 px-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 px-4 h3-medium">Changes to This Policy</h3>
    <p class="sm:pl-6 px-6 desktop:paragraph-regular paragraph-mobile-small">
    ...
    <h3 class="pb-6 pt-4 px-4 h3-medium">Contact Us</h3>
    <p class="sm:pl-6 px-6 desktop:paragraph-regular paragraph-mobile-small">
