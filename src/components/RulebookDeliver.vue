<template>
  <div class="study-grid h-auto mb-16">
    <div class="xl:col-start-1 xl:col-end-7 col-span-full text-left">
      ...
      <div class="">
        ...
        <div class="sm:px-3 sm:pl-8 sm:pr-4 mt-2">
          <p class="xl:paragraph-regular paragraph-mobile-small">
          ...
          <p class="paragraph-mobile-small font-bold xl:paragraph-regular-bold">Check out my 
            <a
    ...
    <div class="xl:col-start-7 xl:col-end-13 col-span-full m-auto">
      <img
  ...
  <div class="study-grid h-auto mb-16">
    <div class="xl:col-start-1 xl:col-end-7 col-span-full text-left">
      ...
      <div class="sm:px-3 sm:pl-8 sm:pr-4 mt-2">
        ...
        <div class="xl:paragraph-regular paragraph-mobile-small">
    ...
    >
      ...
      <div
        class="pr-3 pl-5 xl:paragraph-regular paragraph-mobile-small"
      >
    ...
    <div
      class="xl:col-start-1 xl:col-end-7 text-left col-span-full sm:pl-8"
    >
    ...
    <div
      class="xl:col-start-1 xl:col-end-7 col-span-full text-left sm:pl-8"
    >
