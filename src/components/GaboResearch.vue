            ...
            <div class="">
              ...
              >
                ...
                <li>
                  ...
                  I haven’t even received an automatic acknowledgement about it,
        ...
        <div class="sm:px-3 sm:pl-8 sm:pr-4 mt-2">
          ...
          <div class="sm:px-3 pl-8 sm:pl-14 sm:pr-4 mt-2">
            <div class="">
              <ul
                ...
                "
              >
                <li>clean copy and design,</li>
                <li>good search and filter options,</li>
                <li>the site to seem trustworthy,</li>
                <li>a wide selection of products,</li>
                <li>the site to be easy to use,</li>
                <li>quick delivery and low shipping price,</li>
                <li>the site to fulfil its promises.</li>
              </ul>
            </div>
          </div>
          <p class="paragraph-mobile-small xl:paragraph-regular">
          ...
          <div class="sm:px-3 pl-8 sm:pl-14 sm:pr-4 mt-2">
            <div class="">
              ...
              >
                <li>
                  <b>Ease of use</b> is more important than buying directly from a
                  publisher.
                </li>
                <li>
                  Participants are <b>price-conscious</b> - wide selection, low
                  delivery fees and discounts are important.
                </li>
                <li>
                  Some users tend to look for books in <b>brick-and-mortar stores</b>
                  first.
                </li>
                <li>
                  Some users mentioned that <b>they didn’t really know smaller
                  chains</b>.
                </li>
                <li>
                  Users most commonly buy from <b>Libri, Bookline, Szellemlovas,
                  Alexandra, Sárkánytűz, Bookdepository</b>.
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="xl:col-start-7 xl:col-end-13 sm:col-start-3 sm:col-end-11 col-span-full row-span-1 self-center">
      ...
      >
        <p class="subheading-bold">
          "I'd hope everything would be okay with my book because I wouldn't know
      ...
      <div class="sm:px-3 pl-8 sm:pl-14 sm:pr-4 mt-2">
        <div class="">
          <ul class="paragraph-mobile-small xl:paragraph-regular list-disc">
            ...
            <li>The <b>contact form could be more usable</b>, but at least it's in an intuitive location. Participants felt that more info could be on this page, e.g. other ways to contact the publisher.</li>
            <li><b>Not having any filtering options when searching or browsing caused some headaches to participants.</b> They also felt that the available sorting options are <b>not satisfactory</b>.</li>
            <li>Some users found the current search functionality <b>(autocomplete) and the results page pleasing</b>.</li>
            <li>Participants felt the way the site handles <b>alert requests for out-of-stock books is redundant and frustrating</b>.</li>
            <li>The <b>product page is too complex while missing some important features</b>, e.g. clickable author name, or input stepper to select multiple copies.</li>
            <li>Participants felt that the <b>checkout process</b> has some interesting features, but <b>should be more intuitive and organised</b>. Missing CTAs on the payments page made them unsure about how to proceed.</li>
          </ul>
        </div>
      </div>
      </div>
