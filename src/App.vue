    ...
    ">
      ...
      <div class="sm:hidden">
        <button @click="isOpen = !isOpen" type="button" class="flex flex-row items-center text-gray-50 hover:text-yellow-400 focus:text-yellow-400 focus:outline-none">
          ...
          <svg class="h-5 w-5 fill-current" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    viewBox="0 0 407.437 407.437" style="enable-background:new 0 0 407.437 407.437;" xml:space="preserve">
  <polygon v-if="!isOpen" points="386.258,91.567 203.718,273.512 21.179,91.567 0,112.815 203.718,315.87 407.437,112.815 "/>
  <polygon v-if="isOpen" points="203.718,91.567 0,294.621 21.179,315.869 203.718,133.924 386.258,315.869 407.436,294.621 "/>
          </svg>
        </button>
      </div>
    </div>
    <nav :class="isOpen ? 'block' : 'hidden'" class="text-left sm:text-center sm:flex sm:p-0 px-2 pt-2 pb-4">
      <a href="" class="sm:text-base desktop:text-xl sm:w-20 sm:mx-2.5 block px-2 py-1 text-gray-50 font-subheading hover:text-yellow-400">About</a>
      <a href="" class="sm:text-base desktop:text-xl sm:w-20 sm:mx-2.5 mt-1 px-2 py-1 sm:mt-0 block text-gray-50 font-subheading hover:text-yellow-400">Work</a>
      <a href="" class="sm:text-base desktop:text-xl sm:w-20 sm:mx-2.5 mt-1 px-2 py-1 sm:mt-0 block text-gray-50 font-subheading hover:text-yellow-400">Contact</a>
    </nav>
  </header>
...
<!-- Case Studies -->
  <div class="desktop:h-496 md:h-496 sm:h-470 px-4 desktop:px-32 md:px-6 sm:px-4 flex flex-row items-end justify-center">
    <div class="desktop:pl-8 md:pl-4 sm:pl-4 desktop:pt-245 md:pt-124 md:pr-80 sm:pt-162 sm:pr-276 h-456 desktop:w-984 md:w-720 sm:w-608 flex flex-col items-start text-left desktop:bg-rulebook-card-desktop md:bg-rulebook-card-tablet sm:bg-rulebook-card-mobile filter bg-cover drop-shadow-card">
      <h2 class="display-smaller-medium text-gray-900">D&D Rulebook</h2>
      <p class="subheading-italic text-gray-900">A mobile-based solution for the players of Dungeons & Dragons.</p>
    </div>
  </div>

<!-- Contact Me -->
  <div class="h-409 px-4 desktop:px-32 md:px-6 sm:px-4 flex flex-col items-center justify-center">
  ...
  <footer class="">
    <div class="w-full flex flex-col">
      <div class="bg-blue-800 h-20 justify-center items-center flex-row px-4 desktop:px-32 md:px-6 sm:px-4 flex">
      ...
      <div class="h-6 bg-blue-900 font-body text-xs text-gray-50 justify-center items-center flex-row flex space-x-4"><span>2021 © All rights reserved by Ádám Sárpátki</span> <span>|</span> <span><a href="">Privacy Policy</a></span></div>
    </div>
  </footer>
</template>
